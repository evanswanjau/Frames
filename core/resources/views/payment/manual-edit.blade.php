            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body pad">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-0">
                                <input class="form-control" name="fix" value="{{ $payment->fix }}" placeholder="Fixed Charge" type="text" required>
                                <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-0">
                                <input class="form-control" name="percent" value="{{ $payment->percent }}" placeholder="Percentage" type="text" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control has-error bold description" rows="5" id="description" name="val1" placeholder="Payment Description (eg: Bank Payment Details)" required>{{ $payment->val1 }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8 col-sm-offset-3">
                            <button type="submit" class="btn btn-primary btn-lg btn-block bold uppercase" id="btn-save" value="add"><i class="fa fa-send"></i> Update Gateway</button>
                        </div>
                    </div>
