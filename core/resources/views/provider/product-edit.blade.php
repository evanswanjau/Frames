                        ...
                        <div class="col-md-10 col-md-offset-1 col-sm-12">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="current_price" id="current_price" class="form-control bold" value="{{ $product->current_price }}" placeholder="Product Price" required/>
                                            <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="charge" id="charge" class="form-control bold" value="{{ $product->charge }}" placeholder="Product Charge" readonly />
                                            <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="rest_amount" id="rest_amount" class="form-control bold" value="{{ $product->rest_amount }}" placeholder="You get Amount" readonly/>
                                            <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                        </div>
                                    </div>
                                </div>
