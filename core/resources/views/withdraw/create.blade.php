                                ...
                                <div class="col-md-10 col-md-offset-1 col-sm-12">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input name="name" value="" class="form-control input-lg" type="text" required placeholder="Method Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input data-toggle="toggle" checked data-onstyle="success" data-offstyle="danger" data-size="large" data-on="Active" data-off="Deactive" data-width="100%" type="checkbox" name="status">
                                            </div>
                                        </div>
