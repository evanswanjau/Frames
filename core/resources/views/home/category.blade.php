                            ...
                            <div class="sidebar-contant">
                                <div class="price-range mb-30">
                                    <form action="{{ route('price-range') }}" method="get">
                                        ...
                                        <div class="inner-title">Select Band</div>
                                        <div class="product-color select-arrow mb-20">
                                            @foreach($band as $b)
                                            <div class="check-box left-side">
                                                <span>
                                                    <input type="checkbox" name="band" value="{{ $b->id }}" class="checkbox subject-list">
                                                </span>
                                                <label for="remember">{{ $b->name }}</label>
                                            </div>
                                            @endforeach
                                        </div>
                                        <div class="inner-title" style="margin-top: 10px;">Select Color</div>
                                        <div class="product-color select-arrow mb-20">
                                            @foreach($color as $c)
                                                <div class="check-box left-side">
                                                <span>
                                                    <input type="checkbox" name="color" value="{{ $c->id }}" class="checkbox subject-list2">
                                                </span>
                                                    <label for="remember">{{ $c->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="inner-title" style="margin-top: 10px;">Select Size</div>
                                        <div class="product-color select-arrow mb-20">
                                            @foreach($size as $s)
                                                <div class="check-box left-side">
                                                <span>
                                                    <input type="checkbox" name="size" value="{{ $s->id }}" class="checkbox subject-list1">
                                                </span>
                                                    <label for="remember">{{ $s->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="inner-title" style="margin-top: 10px;">Price Range</div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('.subject-list1').on('change', function() {
            $('.subject-list1').not(this).prop('checked', false);
        });
