...
*/
$consumer_key = '01+wBW/w8w+CylQGteNPMY1dYYAXiW9S';//'6sScmWYmmDeBlOTd+hV/1JUy8FfxcNrE';//Register a merchant account on
                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret = 'vcPusLeWuqBT1xbMo41yY3/kFQc=';//IptVnUOVreFqBYUMOXH7K6dqw2A=';// Use the secret from your test
...
//get form details
$amount = 1000;//$order['order_number'];//$_POST['amount'];
$amount = number_format($amount, 2);//format amount to 2 decimal places

$desc = 'Frame payment';//$_POST['description'];
$type = 'MERCHANT';//$_POST['type']; //default value = MERCHANT
$reference = $order['order_number'];//$_POST['reference'];//unique order id of the transaction, generated by merchant
$first_name = $user['first_name'];//$_POST['first_name'];
$last_name = $user['last_name'];//$_POST['last_name'];
$email = $user['email'];//$_POST['email'];
$phonenumber = $user_s['s_number'];//ONE of email or phonenumber is required
$currency= '';

$callback_url = '127.0.0.1/frames/shop/payment-complete/?order_id=' . $order['id'] . '&user_id=' . $user['id'];//'frames.co.ke/pesapal/pesapal-ipn-listener.php'; //redirect url, the page that will handle the response from pesapal.
