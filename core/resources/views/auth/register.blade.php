                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 mb-20">
                                        ...
                                        <div class="check-box">
                                            ...
                                            <label for="agree">I Agree with the <a href="{{ route('terms-conditions') }}" class="link">Terms & Conditions</a> and <a class="link" href="{{ route('privacy-policy') }}">Privacy Policy</a> </label>
