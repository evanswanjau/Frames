        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <div class="box-title">
                        <button id="btn_add" name="btn_add" class="btn btn-primary bold"><i class="fa fa-plus"></i> New Subcategory</button>
                    </div>
                    <!-- tools box -->
                ...
                <div class="box-body pad">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach ($subcategory as $key => $product)
        ...
        <div class="modal-dialog" style="width: 45%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title bold uppercase" id="myModalLabel"><i class="fa fa-indent"></i> Product Subcategory</h4>
                </div>
                <div class="modal-body">
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" novalidate="">
                        <div class="form-group">
                            <label for="inputName" class="col-sm-4 control-label bold uppercase">Select Category : </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-4 control-label bold uppercase">Subcategory Name : </label>
                            <div class="col-sm-8">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary bold uppercase" id="btn-save" value="add"><i class="fa fa-send"></i> Save Subcategory</button>
    ...
    <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('sub-category-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {!! method_field('delete') !!}
    ...
    <script>
        ...
        $("#btn-save").click(function (e) {
            ...
            $.ajax({
                ...
                toastr.success('Successfully Subcategory Saved.');
            });
        });
        $(function () {
            $('.select2').select2();
