                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="sku" class="form-control bold" value="{{ strtoupper(\Illuminate\Support\Str::random(11)) }}" placeholder="Product SKU Number" required/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="current_price" class="form-control bold" value="{{ old('current_price') }}" placeholder="Product Price" required/>
                                ...
                                <div id="wrapper">
                                    <div id="dynamicInput">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <a id="add-form" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add Filed</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <select class="form-control select2 bold" data-placeholder="Select Mood" id="mood_id" name="mood_id" style="width: 100%;">
                                                <option class="bold" value="">Select Mood</option>
