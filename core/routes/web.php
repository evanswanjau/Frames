...
Route::get('shipping-policy',['as'=>'shipping-policy','uses'=>'HomeController@getShippingPolicy']);
Route::get('return-policy',['as'=>'return-policy','uses'=>'HomeController@getReturnPolicy']);
...
Route::post('pesaPal',['as'=>'pesaPal','uses'=>'UserController@pesaPal']);
...
/**
 * Here lays Evans Wanjau's code on frames update.
 */
// image upload
// Route::get('image-upload', 'ImageUploadController@imageUpload')->name('image.upload');
Route::post('image-upload', 'ImageUploadController@imageUploadPost')->name('image.upload.post');
Route::post('image-to-cart', 'ImageUploadController@addImageToCart')->name('image.cart');
Route::get('remove-from-cart', 'ImageUploadController@removeImageFromCart')->name('image_remove.cart');
...
// payment new route
Route::get('payment-complete', 'UserController@paymentComplete');

// login and log out
Route::get('/redirect', 'SocialAuthFacebookController@redirect');
Route::get('/callback', 'SocialAuthFacebookController@callback');

Route::get('/gredirect', 'SocialAuthGoogleController@googleRedirect');
Route::get('/gcallback', 'SocialAuthGoogleController@googleCallback');