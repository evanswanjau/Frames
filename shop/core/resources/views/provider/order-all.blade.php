                    ...
                    <table class="table table-bordered table-hover" id="myTable">
                        ...
                        @foreach ($order as $key => $product)
                            <tr id="product{{$key}}">
                                ...
                                <td>{{$product->qty}}</td>
                                <td>{{ $basic->symbol }}{{$product->product->current_price * $product->qty}}</td>
                                <td>{{ $basic->symbol }}{{$product->charge}}</td>
                                <td>{{ $basic->symbol }}{{$product->provider_amount}}</td>
                                {{--<td>
                                ...
                                <td>
                                    <a href="{{ route('provider-order-view',['order'=>$product->order_number,'id'=>$product->id]) }}" class="btn btn-sm btn-primary bold uppercase"><i class="fa fa-eye"></i> View Order</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
