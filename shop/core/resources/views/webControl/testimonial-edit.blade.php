                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input data-toggle="toggle" {{ $testimonial->status == 1 ? 'checked' : '' }} data-onstyle="success" data-offstyle="danger" data-on="Publish" data-off="Pending" data-width="100%" data-size="large" type="checkbox" name="status">
                                    </div>
                                </div>
