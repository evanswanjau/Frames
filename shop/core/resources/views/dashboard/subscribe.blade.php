            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body pad">
                    ...
                    <table class="table table-bordered table-hover" id="myTable">
                        ...
                        @foreach ($subscribe as $key => $product)
                            <tr id="product{{$key}}">
                                <td>{{++$key}}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Are you sure you want to Do Delete Subscriber. ?</strong>
                </div>

                <div class="modal-footer">
                    <form method="post" action="{{ route('subscriber-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('delete') }}
