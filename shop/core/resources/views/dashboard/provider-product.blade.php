                        ...
                        @foreach ($products as $key => $product)
                            <tr id="product{{$key}}" class="{{ $product->stock < 10 ? 'warning' : ''  }}">
                                ...
                                <td>
                                    ...
                                    {{ $product->provider->email }}<br>
                                    {{ $product->provider->country_code }}{{ $product->provider->phone }}
                                </td>
                                <td>{{ $product->name }}</td>
                                ...
                                <td>
                                    <a href="{{ route('product-edit',$product->id) }}" class="btn btn-sm btn-primary bold uppercase"><i class="fa fa-edit"></i> Edit Product</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
