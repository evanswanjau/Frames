                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input name="sku" class="form-control bold" value="{{ $product->sku }}" placeholder="Product SKU Number" required/>
                                ...
                                <div class='form-group'>
                                    ...
                                    @foreach($productSpecification as $ps)
                                        <div id="sp{{$ps->id}}">
                                            ...
                                            <div class="col-sm-2">
                                                <a data-id="sp{{ $ps->id }}" class='ex_delete_button btn btn-danger btn-block' style="margin-bottom: 10px;"><i class='fa fa-times'></i> Remove Field</a>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div id="wrapper">
                                    <div id="dynamicInput">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <a id="add-form" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add Another</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Product Mood</strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <select class="form-control select2 bold" data-placeholder="Select Mood" id="mood_id" name="mood_id" style="width: 100%;">
                                                @if($product->mood_id == 0)
                                                    <option class="bold" value="0" selected>Sell Mood</option>
                                                    <option class="bold" value="1">New Mood</option>
                                                    <option class="bold" value="2">Hot Mood</option>
                                                @elseif($product->mood_id == 1)
                                                    <option class="bold" value="0">Sell Mood</option>
                                                    <option class="bold" value="1" selected>New Mood</option>
                                                    <option class="bold" value="2">Hot Mood</option>
                                                @elseif($product->mood_id == 2)
                                                    <option class="bold" value="0">Sell Mood</option>
                                                    <option class="bold" value="1">New Mood</option>
                                                    <option class="bold" value="2" selected>Hot Mood</option>
                                                @endif
                                            </select>
                                            <span class="input-group-addon"><strong><i class="fa fa-indent"></i></strong></span>
                                        </div>
...
@section('scripts')
    ...
    <script>
        $(document).on("click", '.ex_delete_button', function (e) {
            var sp_id = $(this).data('id');
            document.getElementById(sp_id).remove();
        });
        var wrapper = $("#wrapper");
        ...
        var getForm = function(index, action) {
            return $("<div class='form-group'><div class='col-sm-10'><input name='specification[]' value='' class='form-control bold' type='text' placeholder='Product Specification'></div><div class='col-sm-2'><a class='remove btn btn-danger btn-block'><i class='fa fa-times'></i> Remove Field</a></div></div>");
        };
