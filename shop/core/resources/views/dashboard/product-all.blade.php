...
@section('content')
                    ...
                    <table class="table table-bordered table-hover" id="myTable">
                        ...
                        @foreach ($products as $key => $product)
                            <tr id="product{{$key}}" class="{{ $product->stock < 10 ? 'warning' : ''  }}">
                                ...
                                <td width="10%">
                                    <a href="{{ route('product-edit',$product->id) }}"  title="Edit Product" class="btn btn-sm btn-primary bold uppercase"><i class="fa fa-edit"></i></a>
                                    <button type="button" title="Delete Product" class="btn btn-sm btn-danger product_delete_button"
                                            data-toggle="modal" data-target="#ProductDelModal"
                                            data-id="{{ $product->id }}">
    ...
    <div class="modal fade" id="ProductDelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function (e) {
            ...
            $(document).on("click", '.product_delete_button', function (e) {
