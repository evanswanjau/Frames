            ...
            <div class="col-xl-12">
                <header>
                    <div class="section-header">
                        <p>software Install wizard</p>
                        <a href="mailto:softwarezon@hotmail.com?Subject=Product%20Installation%20Support" target="_top"><i class="fa fa-handshake"></i> Get Support</a>
                    </div>
                </header>
                                ...
                                try{
                                    ...
                                    if ($status->error == 1) {
                                        ...
                                        echo '<div style="text-align:center; text-transform:uppercase;">
                                              ...
                                              <a href="' . $base_url . '" class="btn btn-success btn-sm">Go to Website</a> <br><br>
                                              <b style="color:red;">"'.$status->message2.'"</b>
                                              <br><br><b style="color:red;">Please Delete The Installer Folder</b><br><br><br></div>';
...
';
                    ...
                    <div class="step-installer first-installer second-installer third-installer">
                        ...
                        <div class="installer-content">
                            <form action="?action=install" method="post">
                                ...
                                <input class="form-control input-lg" name="db_host" placeholder="Database Host eg: localhost" type="text" required=""><br>
                                <input class="form-control input-lg" name="db_user" placeholder="Database Username" type="text" required=""><br>
                                <input class="form-control input-lg" name="db_pass" placeholder="Database Password" type="text"><br>
                ...
                <div class="step-installer first-installer second-installer">
                    <div class="installer-header" style="text-transform: uppercase;"><h1>Server Requirements</h1></div>
                    <div class="installer-content table-responsive">
                        <table class="table table-striped" style="text-align: left;">
                            ...
                            if ($phpversion == true) {
                                $error = $error + 0;
                                createTable("PHP", "Required PHP version 7.0.0 or higher", 1);
                            } else {
                                $error = $error + 1;
                                createTable("PHP", "Required PHP version 7.0.0 or higher", 0);
                            }
                ...
                <div class="step-installer first-installer">
                    ...
                    <div class="installer-content">
                        <p style="text-align: left;">
                            <strong>Regular License to be used on one (1) domain only !</strong> <br><br>
                            The Regular license is for one website / domain only. <br>
                            If you want to use it on multiple websites / domains you have to purchase more licenses.
                            <br>(1 website = 1 license).<br><br>
